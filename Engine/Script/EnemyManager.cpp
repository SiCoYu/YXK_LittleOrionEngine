...
CEnemyManager* EnemyManagerDLL()
{
	CEnemyManager* instance = new CEnemyManager();
	return instance;
}
...
void CEnemyManager::AddEnemy(EnemyController* enemy)
{
	enemies.emplace_back(enemy);
}

void CEnemyManager::KillEnemy(EnemyController* enemy)
{
...
void CEnemyManager::SpawnEnemy(EnemyType type, const float3& spawn_position, bool invincible)
{
...
void CEnemyManager::SpawnWave(std::vector<float3>& spawns, unsigned enemies_per_wave, EnemyType enemy_type)
{
...
void CEnemyManager::InitEnemies()
{
...
void CEnemyManager::OnInspector(ImGuiContext* context)
{
...
void CEnemyManager::InitPublicGameObjects()
{
...
bool CEnemyManager::ArePlayersInDanger() const
{
...
void CEnemyManager::CancelMeleeAttack(EnemyController* enemy)
{
	--current_melee_mushdoom_attackers;
}

void CEnemyManager::CancelRangedAttack(EnemyController* enemy)
{
	--current_ranged_mushdoom_attackers;
}

bool CEnemyManager::CheckSpawnAvailability(float3& spawn_position)
{
	for (const auto& enemy : enemies)
	{
		if (!enemy->is_alive)
...
void CEnemyManager::KillAllTheEnemies()
{
...
void CEnemyManager::NewRequestAttack(EnemyController* enemy)
{
...
bool CEnemyManager::IsEnemyAttacking(EnemyController* enemy)
{
	return IsEnemyMeleeAttacking(enemy) || IsEnemyRangedAttacking(enemy);
}

bool CEnemyManager::IsEnemyMeleeAttacking(EnemyController* enemy)
{
	return static_cast<Mushdoom*>(enemy)->engage_player;
}

bool CEnemyManager::IsEnemyRangedAttacking(EnemyController* enemy)
{
